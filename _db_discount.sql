...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 09:31 AM
...
CREATE TABLE `tb_transaksi` (
  ...
  `tanggal_transaksi` int(50) NOT NULL,
...
ALTER TABLE `tb_transaksi`
  ...
  ADD CONSTRAINT `tb_transaksi_ibfk_2` FOREIGN KEY (`id_barang`) REFERENCES `tb_barang` (`id_barang`);
COMMIT;
